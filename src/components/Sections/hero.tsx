...
//                 >
//                     <div
//                         className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden border-4 border-white shadow-2xl">
//                         {/* Increase width/height for a larger image */}
//                         <Image
//                             src="/images/my.jpg"
//                             alt="Praneeth"
//                             width={384} // Adjusted to match the div size
//                             height={384}
//                             priority
...
//                     className="flex-1 text-center md:text-left md:ml-12 max-w-lg"
//                 >
...
import Image from "next/image";
import {motion} from "framer-motion";
import {HiArrowNarrowRight} from "react-icons/hi"; // Importing an arrow icon
